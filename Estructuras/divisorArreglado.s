...
.data
prompt: .asciiz "Ingrese el valor del divisor (Numero menor) "
prompt2: .asciiz "Ingrese el valor del dividendo (Numero mayor) "
...
addi $s0, $s0, 0
addi $s1, $zero, 0 #Residuo

addi $s2, $s2, 0
addi $s3, $zero, 0 #Divisor
