...
SERVERDIR='/var/nfs-server/LaboratorioDigitales' # Directorio en el servidor
...
case "$COMMAND" in
	...
	then
	    sudo mount -t nfs -o intr,soft,timeo=5,retrans=5,actimeo=10,retry=3  "192.168.12.218:""$SERVERDIR" "$DIR"
